...
⚠️  WARNING: IMPURE OPERATIONS DETECTED ⚠️
╔═══════════════════════════════════════════════════════════╗
║                                                           ║
║  🚨 YOU ARE ABOUT TO PERFORM IMPURE OPERATIONS! 🚨        ║
║                                                           ║
║  This will make network calls and other side effects that ║
║  cannot be guaranteed to produce consistent results.      ║
║                                                           ║
...
✨ Successfully purified function:
┌─ getTheWeather()
│  get("https://api.example.com/weather").as_json()["is_sunny"]
└─ 🔒 sha256-qOfWjQ2JQSQL15KLh6D7xQhx0qgZlYZTYlcEiRuAMMw=

📝 Updated Hashfile with new lock
```
